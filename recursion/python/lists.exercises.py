...
def largest(lst):
    ...
    Hint: What's the base case for a SINGLE element list?
    """
...
def length(lst):
    ...
    Hint: You don't need to use `first` at all!
    """
    if is_empty(lst):
        return _____
...
def all_equal(lst):
    ...
    Hint: Compare each element to the next one.
    """
    if is_empty(lst):
        return _____
...
def index_of(val, lst):
    ...
    Hint: You may want a helper function that tracks the current index.
    """
    def helper(lst, idx):
        if is_empty(lst):
            return _____
...
def last(lst):
    ...
    Hint: Base case is a single-element list, not empty list.
    """
    if is_empty(lst.next):
        return _____
...
def nth(n, lst):
    ...
    Hint: This recurses on BOTH n and lst.
    """
    if n == 0:
        return _____
...
def init(lst):
    ...
    Hint: Base case is single-element list.
    """
    if is_empty(lst.next):
        return _____
...
def reverse(lst):
    ...
    Hint: You'll need the append function.
    """
    if is_empty(lst):
        return _____
...
def intersperse(sep, lst):
    ...
    Hint: Base case is single element OR empty.
    """
    if is_empty(lst):
        return _____
...
def unique(lst):
    ...
    Hint: Use the `contains` function and `without` or `filter_list`.
    """
    if is_empty(lst):
        return _____
...
def merge(lst1, lst2):
    ...
    Hint: Compare the first elements to decide which goes first.
    """
    if is_empty(lst1):
        return _____
...
def partition(pred, lst):
    ...
    Hint: Return a TUPLE of two lists.
    """
    if is_empty(lst):
        return _____
...
def indexed(lst):
    ...
    Hint: Use a helper with an index accumulator.
    """
    def helper(lst, idx):
        if is_empty(lst):
            return _____
...
def inits(lst):
    ...
    Hint: This one is trickier. Consider using map.
    """
    if is_empty(lst):
        return _____
...
def insertion_sort(lst):
    ...
    Hint: This is just a fold with insert_sorted!
    """
    if is_empty(lst):
        return _____
